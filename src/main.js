import './style.css';
const PROFILE = {"day":"Day032","title":"Slot Ribbon Planner 1","display_name_ja":"時間配分プランナー","one_sentence":"時間や作業の分け方を決めやすくするためのツールです。","purpose_line_ja":"時間や作業の分け方を決めやすくするためのツールです。","use_case_line_ja":"限られた時間で何をどこに入れるか迷う時に使います。","how_it_works_line_ja":"やることを入れると、分けた結果が見られます。","core_action":"place","family":"resource_split","mechanic":"slot_map","input_style":"cards","output_style":"timeline","audience_promise":"control","publish_hook":"重み付き評価で候補案の順位変化を比較できる計算ツール。（話題:GitHub Trending (A） を relatable_pain 角度で見せる","engine":"habit_slots","interaction_archetype":"slot_map","page_archetype":"timeline_ribbon","output_shape":"timeline_ribbon","state_model":"slot_map_state","core_loop":"cards -> slot_map -> timeline","component_pack":"timeline_ribbon+timeline","scaffold_id":"slot_checklist_planner","single_shot_text_generator":false};
